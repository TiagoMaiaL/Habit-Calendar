...
class UserStorageTests: IntegrationTestCase {
    ...
    func testUserCreation() {
        ...
        XCTAssertNotNil(user.created, "User creation.")
    ...
    func testUserRetrieval() {
        ...
        XCTAssertNil(user, "No user shoud be fetched, since no user was created.")
        ...
        XCTAssertNotNil(user, "A user should be fetched from the getUser() method.")
        // Check if the retrieved user is the same
        // as the previously created one.
        XCTAssertEqual(userId, fetchedUserId, "The fetched user's id should be equal to the id of the previously created user.")
    }
    ...
    func testUserDeletion() {
        ...
        XCTAssertNil(user ?? nil, "The created user should be deleted.")
    }
